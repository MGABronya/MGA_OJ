// @Title  recordCompetition
// @Description  定义个人赛的提交记录
// @Author  MGAronya（张健）
...
// recordCompetition			定义个人赛的提交记录
type RecordCompetition struct {
	...
	CompetitionId uuid.UUID `json:"competition_id" gorm:"type:char(36);primary_key"`              // 竞赛id
...
// @return    error
func (record *RecordCompetition) BeforeCreate(scope *gorm.DB) error {
