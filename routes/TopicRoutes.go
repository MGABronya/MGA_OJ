...
func TopicRoutes(r *gin.Engine) *gin.Engine {
	...
	// TODO 取消点赞、点踩状态
	topicRoutes.DELETE("/cancel/like/:id", middleware.AuthMiddleware(), topicController.CancelLike)
	...
	// TODO 查看用户点赞、点踩列表
	topicRoutes.GET("/likes/:id", topicController.Likes)
	...
	// TODO 查看用户收藏夹
	topicRoutes.GET("/collects/:id", topicController.Collects)
	...
	// TODO 按文本搜索主题
	topicRoutes.GET("/search/in/topic/:text/:id", topicController.SearchInTopic)

	// TODO 按标签搜索主题
	topicRoutes.GET("/search/label/in/topic/:id", topicController.SearchLabelInTopic)

	// TODO 按文本和标签交集搜索主题
	topicRoutes.GET("/search/with/label/in/topic/:text/:id", topicController.SearchWithLabelInTopic)

	// TODO 获取主题热度排行
	topicRoutes.GET("/hot/rank", topicController.HotRanking)
